...
@section('title', config('support.name'))
...
@section('page-style')
  ...
  <link rel="stylesheet" href="{{ asset('themes/girisoft/css/base/pages/app-email.css') }}">
    ...
    <ul class="email-media-list">
      <li class="media mail-read">
        <div class="media-left pr-50">
          <div class="avatar">
            <img src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-20.jpg') }}" alt="avatar img holder" />
          </div>
      ...
      <li class="media">
        <div class="media-left pr-50">
          <div class="avatar">
            <img src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-17.jpg') }}" alt="Generic placeholder image" />
          </div>
          <div class="user-action">
            <div class="custom-control custom-checkbox">
      ...
      <li class="media mail-read">
        <div class="media-left pr-50">
          <div class="avatar">
            <img src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-7.jpg') }}" alt="Generic placeholder image" />
          </div>
          <div class="user-action">
            <div class="custom-control custom-checkbox">
      ...
      <li class="media mail-read">
        <div class="media-left pr-50">
          <div class="avatar">
            <img src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-5.jpg') }}" alt="Generic placeholder image" />
          </div>
          <div class="user-action">
            <div class="custom-control custom-checkbox">
      ...
      <li class="media">
        <div class="media-left pr-50">
          <div class="avatar">
            <img src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-3.jpg') }}" alt="Generic placeholder image" />
          </div>
          <div class="user-action">
            <div class="custom-control custom-checkbox">
      ...
      <li class="media">
        <div class="media-left pr-50">
          <div class="avatar">
            <img src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-8.jpg') }}" alt="Generic placeholder image" />
          </div>
          <div class="user-action">
            <div class="custom-control custom-checkbox">
      ...
      <li class="media mail-read">
        <div class="media-left pr-50">
          <div class="avatar">
            <img src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-11.jpg') }}" alt="Generic placeholder image" />
          </div>
          <div class="user-action">
            <div class="custom-control custom-checkbox">
      ...
      <li class="media mail-read">
        <div class="media-left pr-50">
          <div class="avatar">
            <img src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-10.jpg') }}" alt="Generic placeholder image" />
          </div>
          <div class="user-action">
            <div class="custom-control custom-checkbox">
      ...
      <li class="media mail-read">
        <div class="media-left pr-50">
          <div class="avatar">
            <img src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-6.jpg') }}" alt="Generic placeholder image" />
          </div>
          <div class="user-action">
            <div class="custom-control custom-checkbox">
      ...
      <li class="media">
        <div class="media-left pr-50">
          <div class="avatar">
            <img src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-9.jpg') }}" alt="Generic placeholder image" />
          </div>
          <div class="user-action">
            <div class="custom-control custom-checkbox">
      ...
      <li class="media">
        <div class="media-left pr-50">
          <div class="avatar">
            <img src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-20.jpg') }}" alt="Generic placeholder image" />
          </div>
          <div class="user-action">
            <div class="custom-control custom-checkbox">
          ...
          <div class="card-header email-detail-head">
            <div class="user-details d-flex justify-content-between align-items-center flex-wrap">
              <div class="avatar mr-75">
                <img
                  src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-9.jpg') }}"
        ...
        <div class="card">
          <div class="card-header email-detail-head">
            <div class="user-details d-flex justify-content-between align-items-center flex-wrap">
              <div class="avatar mr-75">
                <img
                  src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-18.jpg') }}"
                  alt="avatar img holder"
                  width="48"
                  height="48"
                />
            ...
            <div class="mail-attachments">
              ...
              <div class="d-flex flex-column">
                <a href="javascript:void(0);" class="mb-50">
                  <img src="{{ asset('themes/girisoft/images/icons/doc.png') }}" class="mr-25" alt="png" height="18" />
                  <small class="text-muted font-weight-bolder">interdum.docx</small>
                </a>
                <a href="javascript:void(0);">
                  <img src="{{ asset('themes/girisoft/images/icons/jpg.png') }}" class="mr-25" alt="png" height="18" />
